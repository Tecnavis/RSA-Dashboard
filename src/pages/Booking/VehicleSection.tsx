...
const VehicleSection = ({ showroomLocation, totalSalary, onUpdateTotalSalary, adjustValueCallback, insuranceAmountBody, onInsuranceAmountBodyChange }) => {
    ...
    useEffect(() => {
        if (!adjustmentApplied.current) {
            ...
            // Avoid deducting insurance amount if "Ready Payment" is selected
            if (showRoom.insurance !== 'ready') {
    ...
    }, [insuranceAmountBody, totalSalary, showRoom.insurance, onUpdateTotalSalary, updatedTotalSalary]);
