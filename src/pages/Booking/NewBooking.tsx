    ...
    return (
        <div>
            ...
            <div className="panel mt-6">
                <h5 className="font-semibold text-lg dark:text-white-light mb-5" >New Bookings    <Link to="/bookings/booking" style={{ 
                    ...
                    padding: "5px 15px",
                    borderRadius: "5px",
                    // transition: "background-color 0.3s, box-shadow 0.3s", // Added box-shadow to the transition property
                    marginLeft: "50px",
                    boxShadow: "0 2px 4px rgba(0, 0, 0, 0.4)", // Added box shadow
                    cursor: "pointer",
                 }}>
